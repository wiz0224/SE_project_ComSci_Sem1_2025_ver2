...
<head>
  ...
  <style>
      /*
    CSS para sa popup overlay.
    Na-adjust para dumikit sa pinakatuktok ng page.
*/
.popup {
    ...
    background-color: rgba(0,0,0,0.4); /* Black w/ opacity for the overlay effect */
}

/* Popup Content */
.popup-content {
    background-color: #fefefe;
    /* Inayos para dumikit sa pinakatuktok, centered horizontally */
    margin: 0 auto; /* Binago mula sa 5% auto para walang espasyo sa taas */
    padding: 20px;
    border: 1px solid #888;
    width: 450px; /* Made the width smaller for a compact look */
    text-align: center;
    border-radius: 10px;
...
<body class="sidebar-collapsed">
    ...
    <div class="sidebar collapsed" id="sidebar" aria-expanded="false">
         ...
         <div class="grouped" >
             <h1 style="margin-bottom: 0; font-size: 2rem; display: inline; vertical-align: middle;">Assistance list</h1>
